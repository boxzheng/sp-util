...
public class JwtUsernamePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse rsp)
        ...
        MD5 m= new MD5();
        String password_cipherText = m.getMD5ofStr(u.getPassword());
        logger.info("############### " +u.getUsername() + "  " + u.getPassword()  + "   " +password_cipherText);
        return getAuthenticationManager().authenticate(new UsernamePasswordAuthenticationToken(
                u.getUsername(), password_cipherText, Collections.emptyList()
        ));
    }
